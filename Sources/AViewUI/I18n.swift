...
enum I18n {
    static let view = NSLocalizedString("view.button.short", bundle: .module, comment: "The text shown on the 'Edit' button")
    static let edit = NSLocalizedString("edit.button.short", bundle: .module, comment: "The text shown on the 'View' button")
